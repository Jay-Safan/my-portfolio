  ...
  return (
    <>
      <div className="flex items-start justify-between gap-4 mb-3">
        <h3 className={`font-semibold text-[rgb(var(--ink))] leading-snug ${featured ? 'text-lg' : ''}`}>{project.title}</h3>
      ...
      <Reveal delay={0}>
        <div style={{ perspective: 800 }}>
          <motion.a
            ...
            whileHover={{ boxShadow: '0 20px 50px rgb(0 0 0 / 0.12)', borderColor: 'rgb(var(--accent))' }}
    ...
    <Reveal delay={index * 100}>
      <div style={{ perspective: 800 }}>
        <motion.a
          ...
          onMouseMove={handleMouseMove}
          onMouseLeave={handleMouseLeave}
          whileHover={{ boxShadow: '0 20px 50px rgb(0 0 0 / 0.12)' }}
          transition={{ duration: 0.25, ease: [0.25, 0.1, 0.25, 1] }}
        >
